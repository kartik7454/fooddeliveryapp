...
console.log(form.size)
  ...
  <h1 className="h-28 bg-slate-100 text-6xl font-bold font-sans text-red-500 text-center italic pt-10">Size</h1>
...
<h1 className="h-28 bg-slate-100 text-6xl font-bold font-sans text-red-500 text-center italic pt-10">Additons</h1>
...
<h1 onClick={addAdditions} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none dark:bg-red-500 dark:hover:bg-red-600 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> ADD</h1>
